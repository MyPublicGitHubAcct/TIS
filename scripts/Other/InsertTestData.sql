...
/** DEPARTMENTS */
EXEC dbtis.tis.sp_CreateDepartment @Name="Art", @isActive=1, @responseMessage="success"
EXEC dbtis.tis.sp_CreateDepartment @Name="Finance", @isActive=1, @responseMessage="success"
EXEC dbtis.tis.sp_CreateDepartment @Name="History", @isActive=1, @responseMessage="success"
EXEC dbtis.tis.sp_CreateDepartment @Name="English", @isActive=1, @responseMessage="success"
EXEC dbtis.tis.sp_CreateDepartment @Name="Pottery", @isActive=1, @responseMessage="success"
...
EXEC dbtis.tis.sp_CreateRole 
    ...
    @AdminAll=1, @responseMessage='success'
GO
...
EXEC dbtis.tis.sp_CreateRole 
    ...
    @AdminAll=0, @responseMessage='success'
GO
...
EXEC dbtis.tis.sp_CreateUser
    ...
    @isManager=0, @isActive=1, @responseMessage='success'
GO
...
EXEC dbtis.tis.sp_CreateUser
    ...
    @isManager=1, @isActive=1, @responseMessage='success'
GO
